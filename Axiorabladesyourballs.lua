...
-- Sections & Tabs
local Tabs = {
    Home = Window:Section({Title = "Home", Opened = true}),
    Players = Window:Section({Title = "Players", Opened = true}),
    Blatant = Window:Section({Title = "Auto Parry", Opened = true}),
    Settings = Window:Section({Title = "Settings", Opened = true})
}

local HomeTab = Tabs.Home:Tab({Title = "Info", Icon = "info"})

local PlayersTab = Tabs.Players:Tab({Title = "Movement", Icon = "user"})

local SettingsTab = Tabs.Settings:Tab({Title = "Settings", Icon = "settings"})

local Blatant = Tabs.Blatant:Tab({Title = "Blatant", Icon = "sword"})

local Players = Tabs.Players:Tab({Title = "Player", Icon = "user"})


-- ===== HOME TAB =====
HomeTab:Paragraph({
    Title = "Credits",
    Desc = "Creator: Axiora | Script Developer: Elvis | Co-Developer: Viper, Zynoxis",
    Color = Color3.fromRGB(255,255,255)
})

HomeTab:Paragraph({
    Title = "Changelog",
    Desc = "v1.0.0 - Hub Features Integrated",
    Color = Color3.fromRGB(180,180,180)
})

local discordInvite = "https://discord.gg/SEEpdm67bH"
HomeTab:Paragraph({
    Title = "Discord Server",
    Desc = "Axiora Official Discord Server!",
...
HomeTab:Button({
    ...
    Callback = function()
        ...
        WindUI:Notify({Title = "Copied!", Content = "Discord invite copied.", Duration = 2})
    end
})
...
BlatantTab:Toggle({
  ...
  Desc = "Sets A Random Parry Accuracy",
  Value = true,
	Callback = function(value)
...
Blatant:Toggle({
   ...
   Desc = "Automatically Spams Parry"
   Value = true,
	Callback = function(value)
        if value then
...
BlatantTab:Toggle({
    Name = "Infinity Detection",
    Desc = "Triggerbot Infinite Detection",
    Value = true,
    Callback = function(value)
...
BlatantTab:Toggle({
    Name = "Random Parry Accuracy",
    Desc = "Lobby Parry Random Accuracy",
    Value = true,
    Callback = function(value)
...
BlatantTab:Toggle({
    Name = "Keypress",
    Desc = "Lobby Auto_Parry Keypress",
    Value = true,
    Callback = function(value)
...
PlayersTab:Slider({
    Title = "Walk Speed",
    Value = {Min = 16, Max = 150, Default = defaultWalkSpeed},
    Callback = function(value)
...
PlayersTab:Slider({
    Title = "Jump Power",
    Value = {Min = 50, Max = 300, Default = defaultJumpPower},
    Callback = function(value)
        if player.Character and player.Character:FindFirstChild("Humanoid") then
