-- Discord server for working games: https://discord.gg/UQxBS7pU6S

-- Made by Elvis

-- Credits to QuirkyCMD
...
MainFrame.BackgroundColor3 = Color3.fromRGB(20, 40, 90) -- dark blue background
MainFrame.Size = UDim2.new(0, 300, 0, 100)
MainFrame.Position = UDim2.new(0.5, -150, 0.2, 0) -- 50% X (centered), 20% Y (down)
...
Title.Size = UDim2.new(1, -40, 0.7, 0)
Title.Position = UDim2.new(0, 10, 0, 10)
Title.Font = Enum.Font.GothamBold
Title.Text = "AxioraCMD By AxioraHub Team"
...
CloseButton.BackgroundColor3 = Color3.fromRGB(0, 120, 255) -- bright blue button
CloseButton.Text = "X"
...
local axioraCMD = Instance.new("ScreenGui")
...
axioraCMD.Name = "axioraCMD"
axioraCMD.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
axioraCMD.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
axioraCMD.ResetOnSpawn = false

main.Name = "main"
main.Parent = axioraCMD
...
cmdBox.PlaceholderText = "AxioraCMD loaded"
cmdBox.Text = ""
...
template.Text = "error, please contact Elvis. you possibly executed AxioraCMD twice."
...
local TweenService = game:GetService("TweenService")
local discordInvite = "https://discord.gg/UQxBS7pU6S"
...
local gui = axioracmd or localPlayer:FindFirstChildOfClass("PlayerGui"):WaitForChild("axioraCMD")
...
local appearSoundId = "rbxassetid://88591874532589"
local discordInvite = "https://discord.gg/UQxBS7pU6S"
...
if not genv.foundRemote then 
	...
	task.wait(3)
	gui:Destroy() 
	return debugPrint("no silly remote found :( try a supported game from our discord server. Invite: discord.gg/UQxBS7pU6S") 
end
...
local scrollText = "AxioraCMD made by Elvis | the best Admin abuse Utility! | "
...
local cmdData = {
	...
	["close"] = "Safely shuts down AxioraCMD by destroying the UI and disconnecting all events.",
}
...
if not inDatabase then
	...
	sgui:SetCore("SendNotification", {
		Title = "AxioraCMD";
		Text = "would you like to log this game? (Logged Games Will Be Sent To Owner)",
		Duration = 300,
		Button1 = "Yes",
		Button2 = "No",
...
debugPrint("AxioraCMD loaded successfully!")